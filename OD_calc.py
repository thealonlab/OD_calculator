...
def main():
    ...
    desired_OD = st.number_input("Enter the desired OD:", min_value=0.01, value=1, step=0.1)
    current_OD = st.number_input("Enter the current OD:", min_value=0.01, value=OD_end, step=0.1)
    growth_rate = st.number_input("Enter the growth rate in generations per hour:", min_value=0.01, value=per_hour, step=0.1)
